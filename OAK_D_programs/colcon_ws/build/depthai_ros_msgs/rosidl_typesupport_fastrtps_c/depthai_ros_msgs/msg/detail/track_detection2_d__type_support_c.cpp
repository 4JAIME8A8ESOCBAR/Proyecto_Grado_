...
#include "depthai_ros_msgs/msg/detail/track_detection2_d__rosidl_typesupport_fastrtps_c.h"
...
using _TrackDetection2D__ros_msg_type = depthai_ros_msgs__msg__TrackDetection2D;

static bool _TrackDetection2D__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _TrackDetection2D__ros_msg_type * ros_message = static_cast<const _TrackDetection2D__ros_msg_type *>(untyped_ros_message);
  // Field name: results
  {
  ...
  // Field name: tracking_age
  {
    cdr << ros_message->tracking_age;
  }
...
static bool _TrackDetection2D__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _TrackDetection2D__ros_msg_type * ros_message = static_cast<_TrackDetection2D__ros_msg_type *>(untyped_ros_message);
  // Field name: results
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  size_t current_alignment)
{
  ...
  // field.name tracking_age
  {
    size_t item_size = sizeof(ros_message->tracking_age);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name tracking_status
...
static uint32_t _TrackDetection2D__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_depthai_ros_msgs__msg__TrackDetection2D(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = depthai_ros_msgs__msg__TrackDetection2D;
    is_plain =
      (
...
static size_t _TrackDetection2D__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_depthai_ros_msgs__msg__TrackDetection2D(
...
static message_type_support_callbacks_t __callbacks_TrackDetection2D = {
  "depthai_ros_msgs::msg",
  "TrackDetection2D",
  _TrackDetection2D__cdr_serialize,
  _TrackDetection2D__cdr_deserialize,
  _TrackDetection2D__get_serialized_size,
  _TrackDetection2D__max_serialized_size
};

static rosidl_message_type_support_t _TrackDetection2D__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_TrackDetection2D,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, depthai_ros_msgs, msg, TrackDetection2D)() {
  return &_TrackDetection2D__type_support;
}
